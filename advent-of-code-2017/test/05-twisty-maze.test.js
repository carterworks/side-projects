...
describe("05 A Maze of Twisty Trampolines, All Alike", function() {
    ...
    it("on the final input, should exit in 28707598 jumps", function(done){
        const input = FINAL_INPUT;
        const expected = 28707598;
        expect(part2(input)).to.equal(expected);
        done();
    });
});