...
const part1 = require("./../solutions/08-registers/solution").part1;
const part2 = require("./../solutions/08-registers/solution").part2;
const computeInstruction = require("./../solutions/08-registers/solution").computeInstruction;
const FINAL_INPUT = `n dec 271 if az < 3
f inc -978 if nm <= 9
g inc -336 if ga < 2
egk dec 437 if y < 5
z dec -550 if g == -336
...
describe("08 Registers", function() {
    describe("Compute Instruction", function() {
        it("on input 'b inc 5 if a > -1', should equal {a: 0, b: 5}", function(done) {
            const input = "b inc 5 if a > -1";
            const registers = {a: 0, b: 0};
            const expected = {a: 0, b: 5};
            const result = computeInstruction(input, registers);
    ...
    describe("part 1", function() {
        it("on non-final input should return 1", function(done) {
            const input = `b inc 5 if a > 1
a inc 1 if b < 5
c dec -10 if a >= 1
c inc -20 if c == 10`;
        ...
        it("on the final input, should return 5215", function(done) {
    ...
    describe("part 2", function() {
        it("on non-final input should return 10", function(done) {
            const input = `b inc 5 if a > 1
a inc 1 if b < 5
c dec -10 if a >= 1
c inc -20 if c == 10`;
        ...
        it("on the final input, should return 6419", function(done) {
            const input = FINAL_INPUT;
            const expected = 6419;
            expect(part2(input)).to.equal(expected);
            done();
