...
const part1 = require("./../solutions/04-high-entroy-passphrases/solution")
  .part1;
const part2 = require("./../solutions/04-high-entroy-passphrases/solution")
  .part2;
const testValidPassphrase = require("./../solutions/04-high-entroy-passphrases/solution").testValidPassphrase;
const testValidPassphrasesWithAnagrams = require("./../solutions/04-high-entroy-passphrases/solution").testValidPassphrasesWithAnagrams;
const FINAL_INPUT = [
...
describe("04-high-entroy-passphrases ", function() {
  describe("decides if passphrase is valid", function() {
    it("'aa bb cc dd ee' should be valid", function(done) {
      const input = "aa bb cc dd ee";
      const expected = true;
      expect(testValidPassphrase(input)).to.equal(expected);
      done();
    });
    it("'aa bb cc dd aa' should be invalid", function(done) {
        const input = "aa bb cc dd aa";
        const expected = false;
        expect(testValidPassphrase(input)).to.equal(expected);
        done();
    });
    it("'aa bb cc dd aaa' should be valid", function(done) {
  ...
  describe("decides if passphrase is valid with anagrams", function() {
    it("'abcde fghij' should be valid", function(done) {
      const input = "abcde fghij";
      const expected = true;
      expect(testValidPassphrasesWithAnagrams(input)).to.equal(expected);
      done();
    });
    it("'abcde xyz ecdab' should be invalid", function(done) {
        const input = "abcde xyz ecdab";
        const expected = false;
        expect(testValidPassphrasesWithAnagrams(input)).to.equal(expected);
        done();
    });
    it("'a ab abc abd abf abj' should be valid", function(done) {
        const input = "a ab abc abd abf abj";
        const expected = true;
        expect(testValidPassphrasesWithAnagrams(input)).to.equal(expected);
        done();
    });
    it("'iiii oiii ooii oooi oooo' should be valid", function(done) {
        const input = "iiii oiii ooii oooi oooo";
        const expected = true;
        expect(testValidPassphrasesWithAnagrams(input)).to.equal(expected);
        done();
    });
    it("'oiii ioii iioi iiio' should be invalid", function(done) {
  ...
  describe("Part 1", function() {
    it(`on final input, should be 451`, function(done) {
  ...
  describe("Part 2", function() {
    it(`on final input, should be 223`, function(done) {
      const input = FINAL_INPUT;
      const expected = 223;
