...
const part1 = require("./../solutions/07-recursive-circus/solution")
  .part1;
const part2 = require("./../solutions/07-recursive-circus/solution")
  .part2;
const FINAL_INPUT = `bqyqwn (68) -> wscqe, cwxspl, syogw, xnxudsh
ddswb (34)
hnkvw (320)
...
describe("07-recursive-circus", function() {
    describe("part 1", function() {
        it("input should return tknk", function(done) {
            const input = `pbga (66)
            xhth (57)
            ebii (61)
            havc (66)
        ...
        it("on the final input, should return eqgvf", function(done) {
            const input = FINAL_INPUT;
            const expected = "eqgvf";
            expect(part1(input)).to.equal(expected);
            done();
        });
    });
    describe("part 2", function() {
        it("on input should return 8", function(done) {
            const input = `pbga (66)
            xhth (57)
            ebii (61)
            havc (66)
        ...
        it("on the final input, should return 757", function(done) {
            const input = FINAL_INPUT;
            const expected = 757;
            expect(part2(input)).to.equal(expected);
            done();
