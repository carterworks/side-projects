...
I misunderstood part two and was not looking for the imbalanced *subtree* for a long time. I thought that we only needed to change the weight of the root's immediate children and that would solve it, not to find the immbalanced node.
That got me sidetracked for about 3 hours.
