import Alpine from "https://cdn.skypack.dev/alpinejs@3.8.0";
const wordList = [
    "cigar",
    "rebut",
    "sissy",
...
function getDateDifference(start, end) {
    ...
    const diffInSeconds = new Date(end).setHours(0, 0, 0, 0) - s.setHours(0, 0, 0, 0);
    return Math.floor(diffInSeconds / 864e5)
}
