...
var Common$ProjectEulerReason = require("./Common.bs.js");

function isDivisible(a, b) {
  return Caml_int32.mod_(a, b) === 0;
}

function isDivisible3or5(a) {
  if (isDivisible(a, 5)) {
    return true;
  } else {
    return isDivisible(a, 3);
  }
}

var __x = Common$ProjectEulerReason.range(0, 1000);

var __x$1 = List.filter(isDivisible3or5)(__x);

var sum = List.fold_left((function (a, b) {
        return a + b | 0;
      }), 0, __x$1);

console.log("Problem 1: " + (String(sum) + ""));

var range = Common$ProjectEulerReason.range;
...
exports.isDivisible3or5 = isDivisible3or5;
exports.sum = sum;
